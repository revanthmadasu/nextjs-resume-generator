...
const SkillSetComp = (): JSX.Element => {
    const agg = [
        {
    ...
    {agg.map(aggregated_skillset => {
        ...
        aggregated_skillset.included.forEach(skill_set => {
            const matched_skills = data.personal.skillset.filter(skill_set_item => skill_set_item.type == skill_set)[0].skills;
